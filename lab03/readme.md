...
В ходе лабораторной работы была создана полноценная пользовательская тема WordPress, включающая:  

- обязательные файлы темы (style.css, index.php);  
- основные шаблоны (header.php, footer.php, sidebar.php);  
- шаблоны для страниц и записей (single.php, page.php, archive.php, comments.php);  
- стилизацию всех элементов темы;  
- навигацию и функционал комментариев;  
- ограничение количества выводимых записей на главной странице;  
- подготовку темы для корректного отображения в админ-панели через screenshot.png.  
